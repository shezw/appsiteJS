  ...
  var defaults = {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['height', ['height']],
        ['table', ['table']],
        ['insert', ['link', 'picture','audio','video', 'hr']],
        ['history',['undo','redo']],
      ...
      keyMap: {
        pc: {
          ...
          'CTRL+SHIFT+R': '右对齐',
          'CTRL+SHIFT+J': '平铺对其',
          'CTRL+SHIFT+NUM7': '原点列表',
          'CTRL+SHIFT+NUM8': '序号列表',
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          shapeRounded: '造型: 圆角',
          shapeCircle: '造型: 圆形',
          shapeThumbnail: '造型: 带边框',
          shapeNone: '造型: 无',
          dragImageHere: '拖动图片或文字到这里',
          dropImage: '将图片拖动至此',
          selectFromFiles: '从文件选择',
          maximumFileSize: '文件最大大小',
          maximumFileSizeError: '超过文件最大大小.',
          url: '图片链接',
          remove: '删除图片'
        },
        audio:{
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      audio: function(lang,options){
        return tplIconButton(options.iconPrefix + options.icons.audio.audio, {
          // event: 'showaudioDialog',
          event: 'uploadAudio',
          title: lang.audio.audio,
          hide: true
        });
      },
